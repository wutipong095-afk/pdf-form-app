...
OutputBaseFilename=FormDD-Setup-{#MyAppVersion}
Compression=lzma2
...
english.CannotCloseApp=Could not close a running FormDD.%n%nPlease close the app window and the "PDF Form Marker" status window, then click OK to try again.
...
thai.CannotCloseApp=ไม่สามารถปิด FormDD ที่กำลังทำงานอยู่ได้%n%nกรุณาปิดหน้าต่างโปรแกรมและหน้าต่างสถานะ "PDF Form Marker" แล้วกด OK เพื่อลองอีกครั้ง
