...
- `index.html` — หน้าแรกภาษาไทย: ปักฟอร์มครั้งเดียว กรอกซ้ำ ข้อมูลอยู่ในเครื่อง · กรอกด่วนในรุ่นปัจจุบัน (ฟรีเฉพาะแพ็กตัวอย่าง)
...
- `pricing.html` — ราคาไทยรายเครื่อง: 1 ปี 99 บาท / ซื้อขาด (LT) 299 บาท / ซื้อขาด + อัปเดต 3 ปี 499 บาท + คิวอาร์พร้อมเพย์ (`img/promptpay-qr.jpeg` ต้องอยู่ในเรป ห้าม deploy ขาดไฟล์นี้) · ไม่มีส่วนลดอัตโนมัติ · แถว 3/5/10 ปีเลิกขายแล้ว
