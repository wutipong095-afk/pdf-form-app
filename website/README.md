...
- `index.html` — หน้าแรกภาษาไทย: ปักฟอร์มครั้งเดียว กรอกซ้ำ ข้อมูลอยู่ในเครื่อง · ประกาศกรอกด่วนในรุ่นถัดไป (ฟรีเฉพาะฟอร์มตัวอย่าง)
- `en.html` — หน้าแรกภาษาอังกฤษ (จุดขายเดียวกัน, ราคา US$19 / 10 ปี ต่อเครื่อง) · Quick Fill กฎเดียวกัน ไม่โชว์ราคาบาท
- `install.html` — วิธีดาวน์โหลดและติดตั้งบน Windows (จอเตือน SmartScreen / SHA256)
- `install.en.html` — English install guide
- `pricing.html` — ราคาไทยรายเครื่อง: 1 ปี 99 บาท / ซื้อขาด (LT) 299 บาท / ซื้อขาด + อัปเดต 3 ปี 499 บาท + คิวอาร์พร้อมเพย์ (`img/promptpay-qr.png` ต้องอยู่ในเรป ห้าม deploy ขาดไฟล์นี้) · ไม่มีส่วนลดอัตโนมัติ · แถว 3/5/10 ปีเลิกขายแล้ว
- `pricing.en.html` — US$19 / เครื่อง / 10 ปี คูณจำนวนเครื่อง ไม่มีส่วนลดอัตโนมัติ ไม่โชว์ราคาบาท
