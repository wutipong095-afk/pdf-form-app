...
เรื่อง: FromDD — ส่งรหัสเครื่องเพื่อรับคีย์

```
ขอบคุณที่ซื้อ FromDD
...
เรื่อง: FromDD — คีย์ไลเซนต์ของเครื่อง {MACHINE_ID}
...
Subject: FromDD — send your machine ID for a license key

```
Thanks for buying FromDD.
...
Subject: FromDD — license key for {MACHINE_ID}
