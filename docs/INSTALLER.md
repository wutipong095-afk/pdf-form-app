...
| `dist/installer/PDFFormMarker-Setup-0.1.9.exe` | ตัวติดตั้ง Inno Setup (ถ้ามี ISCC) |
...
ผลลัพธ์: `dist\PDFFormMarker\PDFFormMarker.exe` และ (ถ้ามี Inno) `dist\installer\PDFFormMarker-Setup-0.1.9.exe`
## ทดสอบบนเครื่องแพ็ก
