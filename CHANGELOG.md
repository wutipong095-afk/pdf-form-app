...
## Unreleased
- ไฟล์งาน `.fromdd` เก็บ PDF ต้นฉบับ + ค่าที่กรอก เปิดแก้ต่อได้ — เทมเพลตเก็บแค่โครงจุด
- กรอกแล้วบันทึกงานอัตโนมัติในโฟลเดอร์ข้อมูลของโปรแกรม (`jobs/`) ไม่ใช่โฟลเดอร์ติดตั้ง
- แถบงานเก่าเปิดไฟล์งานเพื่อแก้ค่า แล้วสร้าง PDF ใหม่ได้ (PDF ที่พิมพ์แล้วยังดูได้อย่างเดียว)
- ปุ่มเปิดโฟลเดอร์ในแถบงานเก่าชี้ไปที่ `jobs/` (ไฟล์ `.fromdd`) ไม่ใช่โฟลเดอร์ PDF ที่พิมพ์แล้ว
