...
| CP7 | Ready to sell | คู่มือไทย, ช่องทางออกคีย์, วิดีโอสั้น, นโยบายซัพพอร์ตชัด · โหมดทดลองชุดเดียวทั้งไทย/ต่างประเทศ — [docs/SALES_LICENSE_PLAN.md](docs/SALES_LICENSE_PLAN.md) |

สถานะปัจจุบันโดยประมาณ: **CP0–CP4** · ต่อไป **CP5–CP7** (pilot + พร้อมขาย; วิดีโอคู่มือยังเป็น follow-up)

งานค้างรายข้อที่คุยระหว่างพัฒนา: [docs/BACKLOG.md](docs/BACKLOG.md)
...
- [x] เวอร์ชันโปรแกรม + แจ้งมีอัปเดต (ไม่บังคับออนไลน์ตอนใช้งาน) — `update_core` + แถบ UI
...
| โมเดลขาย | Setup ชุดเดียว · ทดลองฟอร์มตัวอย่าง · Activate ปลดล็อก · ขายรายเครื่อง |
| ราคาไทย | 99 / 299 / 499 บาท ต่อเครื่อง (1 ปี · ซื้อขาด · ซื้อขาด+อัปเดต 3 ปี) |
| ราคาต่างประเทศ | Personal US$49 จ่ายครั้งเดียว ไม่โฆษณา 10 ปี · อัปเดตตราบที่คีย์ยังใช้ได้ · ไม่โชว์ราคาบาท |
| ที่รัน | เครื่องผู้ใช้ (local-first) |
| ไลเซนต์ | Ed25519 ผูกเครื่อง · ออกคีย์มือระยะแรก แล้วหน้า Activate |
