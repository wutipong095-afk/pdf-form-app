...
สถานะปัจจุบันโดยประมาณ: **CP0 ผ่านแล้ว** → กำลังทำ **CP-TS** คู่กับ **CP1**
...
- [ ] Settings: เลือกโฟลเดอร์รากเอกสาร
- [ ] สร้างโครงเริ่มต้น / สแกนคลัง
- [ ] รองรับโฟลเดอร์ย่อยไม่จำกัดความลึก (หรือจำกัดระดับที่สมเหตุสมผล เช่น 3)
- [ ] ดัชนี `.pdfmarker/index.json` (ชื่อ, path, โฟลเดอร์, แท็ก, ใช้ล่าสุด)
- [ ] ช่องค้นหาเดียว: ชื่อ / โฟลเดอร์ / แท็ก / ล่าสุด
- [ ] ปุ่มเปิดใน Explorer
- [ ] จับคู่เทมเพลต: `ชื่อ.pdf` + `ชื่อ.tpl.json` (รุ่นแรก) หรือผูกผ่าน metadata
- [ ] เมื่อเปิดโปรแกรมหรือกดรีเฟรช: สแกนใหม่เฉพาะไฟล์ที่เปลี่ยน
